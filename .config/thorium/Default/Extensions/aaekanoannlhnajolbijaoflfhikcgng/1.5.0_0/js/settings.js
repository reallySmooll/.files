...
function themeIconURL(theme) {
    if (theme == CHARCOAL_MODE) {
        return chrome.runtime.getURL("assets/charcoal-messenger.svg");
    } else if (theme == MIDNIGHT_MODE) {
        return chrome.runtime.getURL("assets/midnight-messenger.svg");
    } else if (theme == DEEPBLUE_MODE) {
        return chrome.runtime.getURL("assets/deepblue-messenger.svg");
    } else {
        return chrome.runtime.getURL("assets/facebook-messenger.svg");
    }
}
